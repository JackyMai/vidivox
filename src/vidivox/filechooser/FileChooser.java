...
public class FileChooser {
	...
	protected static FileNameExtensionFilter videoSaveFilter = new FileNameExtensionFilter("AVI Files (.avi)", "avi");
	protected static FileNameExtensionFilter audioFilter = new FileNameExtensionFilter("MP3 Files (.mp3)", "mp3");
